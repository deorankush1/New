 ...
 */
class PayUbiz_PayUbiz_Model_Payumoney extends Mage_Payment_Model_Method_Abstract
{
    protected $_code = 'payucheckout_payumoney';
    protected $_formBlockType = 'payubiz/payumoney';
